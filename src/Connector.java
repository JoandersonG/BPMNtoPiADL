public class Connector {
    ...
    public String toPiADL() {
        ...
        piADLcode.append("\tconnection ").append("para").append((to != null ? to.getId() : "Sem id")).append(" is out (Integer)\n");
        piADLcode.append("\tprotocol is {\n")
                .append("\t\t(via ").append("de").append((from != null ? from.getId() : "Sem id")).append(" receive Integer |")
                .append(" via ").append("para").append((to != null ? to.getId() : "Sem id")).append(" send Integer)*\n")
                .append("\t}\n")
                .append("\tbehavior is {\n")
                .append("\t\tvia ").append("de").append((from != null ? from.getId() : "Sem id")
        ).append(" receive x : Integer\n")
                .append("\t\tvia ").append("para").append((to != null ? to.getId() : "Sem id")).append(" send x\n")
                .append("\t\tbehavior()\n")
                .append("\t}\n")
                .append("}\n");
    ...
    public String toString() {
        return "Id:" + id + "    From: " + (from != null ? from.getId() : "Sem nome") +
                "    To: " + (to != null ? to.getId() : "Sem nome") ;
    }
}
